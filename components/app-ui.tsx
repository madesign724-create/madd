...
export function AppTextInput({
  ...
  return (
    <View style={[styles.inputGroup, containerStyle]}>
      ...
      <TextInput
        placeholderTextColor="#686152"
        {...props}
        style={[styles.inputField, inputStyle, style]}
      />
    </View>
  );
}
  ...
  return (
    <View style={styles.emptyState}>
      <View style={styles.emptyIcon}>
        <MaterialIcons name={icon} size={28} color={Brand.pine} />
      </View>
...
export function StatusPill({ status }: { status: string }) {
  ...
  return (
    <View style={[styles.statusPill, { backgroundColor: current.background }]}>
