...
const styles = StyleSheet.create({
  ...
  topBar: { minHeight: 54, direction: "rtl", flexDirection: "row", alignItems: "center", marginBottom: 18 },
  ...
  heroContent: { flex: 1, alignSelf: "stretch", direction: "rtl", alignItems: "flex-start", justifyContent: "flex-end", zIndex: 1 },
  ...
  sectionHeading: { direction: "rtl", flexDirection: "row", justifyContent: "space-between", alignItems: "flex-end", marginTop: 32, marginBottom: 14 },
  ...
  allLink: { direction: "rtl", minHeight: 34, flexDirection: "row", alignItems: "center", gap: 4 },
  ...
  serviceCopy: { flex: 1, direction: "rtl", flexDirection: "row", alignItems: "flex-end", justifyContent: "space-between", padding: 16 },
