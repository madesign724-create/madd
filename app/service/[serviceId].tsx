...
const styles = StyleSheet.create({
  ...
  flatList: { direction: "rtl" },
  list: { paddingBottom: 28, direction: "rtl" },
  hero: { height: 190, marginBottom: 18, borderRadius: 23, overflow: "hidden", position: "relative", direction: "rtl", backgroundColor: "#211B10", borderWidth: 1, borderColor: "#665529" },
  ...
  heroCopy: { flex: 1, alignSelf: "stretch", alignItems: "flex-end", justifyContent: "flex-end", direction: "rtl", padding: 19 },
  ...
  card: { minHeight: 87, direction: "rtl", flexDirection: "row-reverse", alignItems: "center", backgroundColor: Brand.card, borderRadius: 19, borderWidth: 1, borderColor: Brand.line, padding: 12, marginBottom: 10, gap: 11 },
  ...
  copy: { flex: 1, alignSelf: "stretch", alignItems: "flex-end", justifyContent: "center", direction: "rtl" },
  ...
  indexBadge: { width: 27, alignItems: "center", direction: "ltr" },
